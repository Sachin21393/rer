function f5() {
  ...
  function f3() {
    ...
    if (x.style.display === "none") {
      ...
      x.style.display = "block";
      x.innerHTML=" Hint 2: My old home town stadium was demolished in the same year as the world's tallest building was inaugurated. (Crack cipher- Reverse the alphabets)"
  ...
  var text=document.getElementById("he").value;
          if(text==='Derek Jeter' || text==='derek jeter' || text==='DEREK JETER'){
            //   var c=a.appendChild(document.createElement('img')).src = 'll.png';
            a.innerHTML="I am considered as the Jack of all trades and have proven this by winning the ICC player of the year award in all the 3 formats of the game. Today I challenge you to find the place where I was supposed to play before I almost collapsed due to myocardial infarction (Ps: It was just a scare )"
          
            var x = document.getElementById("show");
            x.innerHTML="";
            var x1 = document.getElementById("s2");
            x1.innerHTML=""
            var x2 = document.getElementById("show1");
            x2.innerHTML="";
              const s=()=>{
                     a1.remove("hint11");
   a2.remove("hint12");
  ...
  setTimeout(()=>{
      ...
      d.classList.remove("hin")
  setTimeout(()=>{
    var d=document.getElementById("hint23");
      d.classList.remove("hin")
  },10000)
